function [extra_space, rms_data] = extra_disturbance_study_known(...
    Fs, n_photons, options)
%extra_disturbance_study_known Known extra disturbance study
% 
%   extra_disturbance_study_known(Fs, n_photons) gives the rms value of the 
%   error for the controller when the extra disurbances are known during design
%   phase. The flux noise is determined by the `n_photons` recieved per
...
%
    ...
    arguments
        ...
        options.extra_type      (1, 1) string  = "narrowband"
