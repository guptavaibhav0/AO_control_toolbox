function search_datadriven_env_hpc(env_idxs, options)
%search_datadriven_env_hpc Run datadriven parameter search on HPC
% 
%   search_datadriven_env_hpc(env_idxs) runs datadriven parameter search for
%   all environments (Fs and n_photons) in the `env_idx` array. `env_idx`can
%   have values between 1 and 16.
% 
%   search_datadriven_env_hpc(___, solver) runs datadriven parameter search and
